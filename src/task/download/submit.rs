...
pub async fn submit_task(state: &AppState, task_param: &param::DownloadMediaFileParam) -> Result<String> {
...
async fn submit_http_download_task(state: &AppState, task_param: &param::DownloadMediaFileParam) -> Result<String> {
...
async fn submit_bt_download_task(state: &AppState, task_param: &param::DownloadMediaFileParam) -> Result<String> {
